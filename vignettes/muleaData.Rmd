...
Ari E, Ölbei M, Gul L, Bohár B, Stirling T (2024). muleaData: ExperimentalData Bioconductor Package for the mulea R Package, Contains Genes Sets for Functional Enrichment Analysis in GMT File Format. R package version 0.99.0, [https://github.com/ELTEbioinformatics/muleaData](https://github.com/ELTEbioinformatics/muleaData).
